...
contract OpenGrant {
    ...
    uint256 constant APPROVAL_REWARD = 100 ether; // 100 ETH reward for approved applications
    ...
    constructor(uint256 _applicationStartTime, uint256 _applicationEndTime) payable {
        ...
        require(msg.value == 5000 ether, "Must send exactly 5000 ETH to initialize the contract.");
